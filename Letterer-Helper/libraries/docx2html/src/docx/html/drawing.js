...
class Properties extends Style.Properties{
	...
	distL(x){
		x && this.style && (this.style.marginLeft=x+'px')
	}
	distT(x){
		x && this.style && (this.style.marginTop=x+'px')
	}
	distB(x){
		x && this.style && (this.style.marginBottom=x+'px')
	}
	distR(x){
		x && this.style && (this.style.marginRight=x+'px')
	}
}
