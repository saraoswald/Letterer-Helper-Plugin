...
Paragraph.Properties = function (_Style$Properties) {
	...
	(0, _createClass3.default)(Properties, [{
		...
		value: function spacing(x) {
			x.bottom && this.style && (this.style.marginBottom = x.bottom + 'px');
			x.top && this.style && (this.style.marginTop = x.top + 'px');

			x.lineHeight && this.style && (this.style.lineHeight = x.lineHeight);
		}
	}]);
	return Properties;
